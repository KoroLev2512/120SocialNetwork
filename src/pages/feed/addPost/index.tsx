                ...
                <div className="relative flex mx-auto justify-center w-full">
                    {image ? (
                        <div className="relative">
                            <Image className="object-cover aspect-square max-w-[350px] rounded-[14px]" width={512}
                                   height={512} src={image} alt="test"/>
                        ...
                        <label htmlFor="imageUpload"
                            ...
                            <div
                                className="flex w-full flex-col bg-app_gray_light-200 dark:bg-app_gray_dark-100 rounded-[14px] max-w-[350px] min-h-[350px]">
                                <div
                                    className="inline-flex w-full h-full items-center justify-center px-[40px] py-[14px]">
                                    <AddIcon/>
                                    <input type="file" id="imageUpload" onChange={ImageUpload} accept="image/*"
                                           style={{display: "none"}}/>
                                </div>
                            </div>
                        </label>
