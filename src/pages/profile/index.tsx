...
export default function Profile() {
    return (
        <main
            className="mx-auto flex h-screen w-full max-w-[420px] flex-col items-center bg-app_gray_light-100 dark:bg-app_gray_dark-200">
            <section
                    ...
                    <Avatar className="size-[74px]">
                        {props.avatar ?
                            (
                                ...
                                <AvatarFallback>
                                    <AvatarIcon height={75} width={75} rotation={0}/>
                                </AvatarFallback>
                            )}
                    </Avatar>
    ...
    return (
        <div className="relative aspect-square">
            {reward ? (
                ...
                <div
                    className="absolute right-1.5 top-1.5 inline-flex items-center gap-x-1 rounded-full bg-white dark:bg-app_gray_dark-200 px-2 py-0.5 text-secondarybody font-medium">
                    Pending...
                </div>
            )}
            <Image
